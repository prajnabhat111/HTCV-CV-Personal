def mpii_get_joint_set(joint_set_name):
    all_joint_names = [
        'spine3', 'spine4', 'spine2', 'spine', 'pelvis',  # 5
        ...
        'right_hip', 'right_knee', 'right_ankle', 'right_foot', 'right_toe'  # 28
    ]

    if joint_set_name == 'all':
        joint_idx = list(range(1, 29))
        joint_parents_o1 = [
            3, 1, 4, 5, 5, 2, 6, 7, 6, 9, 10, 11, 12,
            6, 14, 15, 16, 17, 5, 19, 20, 21, 22, 5, 24, 25, 26, 27
        ]
        joint_parents_o2 = [
            4, 3, 5, 5, 5, 1, 2, 6, 2, 6, 9, 10, 11,
            2, 6, 14, 15, 16, 4, 5, 19, 20, 21, 4, 5, 24, 25, 26
        ]
        joint_names = all_joint_names

    elif joint_set_name == 'relevant':  # Human3.6m compatible joint set in Our order
    ...
    elif joint_set_name == 'extended':  # Human3.6m compatible joint set in Our order + End effectors for Hands and Feet
